            ...
            parallel{
                stage('Build') {
                    steps {
                            ...
                            uvicorn main:app --reload --host 127.0.0.1 --port 80 > /home/jenkins/workspace/prometheus_test/api_output.log >&1
                            '''
                            /*
                            script{
                            ...
                            for (int i=0; i < maxRetries; i++){
                                try {
                                    ...
                                    if (status == "200" || status == "201") {
                                        ...
                                        def fastapi_pid = sh( script: "head -n 4 /home/jenkins/workspace/prometheus_test/api_output.log | grep -Eo '[0-9]' | tail -1")
